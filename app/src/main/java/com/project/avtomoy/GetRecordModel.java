...
public class GetRecordModel {
    ...
    public GetRecordModel(Integer id, Integer users_id, Integer time_start, Integer time_end, Integer price, Integer status, Integer boxes_id, Integer car_type, Integer car_region, String car_washes_id, String date, String services_ids, String add_services_ids, String comment, String car_mark, String car_number, String phone, String client_name) {
        this.id = id;
