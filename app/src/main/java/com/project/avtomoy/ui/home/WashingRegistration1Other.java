...
public class WashingRegistration1Other extends Fragment {
    ...
    public static WashingRegistration2Other fragmentWashingReg;
    ...
    public static DutyAdapterOther hisAdapter;
    public static ServiceAdapterOther hisAdapter2;
    public static AdvetFinishClass advetFinishClass;
    static ArrayList<Car> carsList = new ArrayList<>();
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_washing_registration_other, container, false);
        GLSelect = view.findViewById(R.id.SelectComplexGVOther);
        GLSelectServices = view.findViewById(R.id.SelectServicesGVOther);
        ...
        try {
            ...
            ArrayList<ServicesClass> com=new ArrayList<ServicesClass>();
            ArrayList<ServicesClass> ser=new ArrayList<ServicesClass>();
            Bundle bundle = this.getArguments();
            if (bundle != null) {
                token = bundle.getString("token", "false");
                load = bundle.getString("Load", "true");
            }
            ...
            hisAdapter = new DutyAdapterOther(HomeFragment.com,AutoRegActivity.SelectComplex);
            ...
            hisAdapter2 = new ServiceAdapterOther(HomeFragment.ser,AutoRegActivity.SelectServices);
            ...
            ((TextView)view.findViewById(R.id.AllComplex)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DutyAdapterCardOther adapter = new DutyAdapterCardOther(HomeFragment.com,AutoRegActivity.SelectComplex);
            ...
            ((TextView)view.findViewById(R.id.AllService)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ServiceAdapterCardOther adapter2 = new ServiceAdapterCardOther(HomeFragment.ser,AutoRegActivity.SelectServices);
            ...
            fragmentWashingReg = new WashingRegistration2Other();
                    ...
                    if (LADC != null) {
                        ...
                        switch (LADC.getResponse().getDates()) {
                            ...
                            case "1":
                                ...
                                break;
                            case "2":
                                instance.add(Calendar.DAY_OF_MONTH, 31);
                                break;
                        }
            ...
            view.findViewById(R.id.infoBtn).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AutoRegActivity.navigationView.getMenu().getItem(2).setChecked(true);
                    InfoFragment infoFragment = new InfoFragment();
                    Bundle args = new Bundle();
                    args.putString("token", token);
                    infoFragment.setArguments(args);
                    LoadInfoFragment(infoFragment);
                }
            });
            view.findViewById(R.id.MyWashBtn).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AutoRegActivity.carWashId = AutoRegActivity.myCarWash;
                    Bundle args = new Bundle();
                    args.putString("token", token);
                    WashingRegistration1 fragmentWashing = new WashingRegistration1();
                    fragmentWashing.setArguments(args);
                    LoadMyWashFragment(fragmentWashing);
                }
            });
            view.findViewById(R.id.mapsBtn).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    private void LoadMyWashFragment(Fragment fragment){
        getFragmentManager().beginTransaction()
                .remove(getFragmentManager().findFragmentByTag("fragmentWash1"))
