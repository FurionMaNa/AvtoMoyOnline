...
public class DutiesViewHolderOther extends RecyclerView.ViewHolder {
    ...
    public DutiesViewHolderOther(@NonNull final View itemView) {
        super(itemView);
        ...
        CL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WashingRegistration1Other.onSelectComplex(v,true);
            }
        });
