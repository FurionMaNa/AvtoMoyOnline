...
public class DutiesViewHolderCardOther extends RecyclerView.ViewHolder {
    ...
    public DutiesViewHolderCardOther(@NonNull final View itemView) {
        super(itemView);
    ...
    public void bindData(final ServicesClass duty, ArrayList<Integer> id){
        ...
        CL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WashingRegistration1Other.onSelectComplex(v,false);
            }
        });
    }
