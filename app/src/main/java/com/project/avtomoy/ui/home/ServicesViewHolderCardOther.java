...
public class ServicesViewHolderCardOther extends RecyclerView.ViewHolder {
    ...
    public ServicesViewHolderCardOther(@NonNull final View itemView) {
        super(itemView);
    ...
    public void bindData(final ServicesClass duty, ArrayList<Integer> id){
        ...
        CL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WashingRegistration1Other.onSelectServices(v,false);
            }
        });
